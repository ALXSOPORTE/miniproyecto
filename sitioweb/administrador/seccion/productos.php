    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                ...
                <input type="text" required class="form-control" name="txtNombre" id="txtNombre" value="<?php echo $txtNombre; ?>"  placeholder="Nombre del producto">
                </div>
    ...
    <table class="table table-bordered">
        ...
        <?php foreach($listaProductos as $producto){ ?>
            <tr>
                ...
                <img class="img-thumbnail rounded" src="../../img/<?php echo $producto['imagen']; ?>" width="150" alt="">
